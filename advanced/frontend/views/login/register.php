	...
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm">
		        ...
		        <input type="text" id="username" name="username" tabindex="1" placeholder="请输入在拉勾使用的名称" style="width: 300px; height: 20px;" />
            ...
            <div class="login_right">
            	<div>已有拉勾帐号</div>
            	<a  href="?r=login/index"  class="registor_now">直接登录</a>
    ...
    <script src="js/only.js"></script>
     <!--  <script>
    	$(function(){
    		...
    		var email = $('#email').val();
    		// unique.data("name:username,email:email");
    		// unique.url('?r=login/register');
            unique.init();
    	});
    </script> -->
    <script type="text/javascript">
    	...
    	//验证表单
	    	 $("#loginForm").validate({
			    	...
			    	submitHandler:function(form){
			            ...
			            $.ajax({
			            	type:'POST',
			            	data: {email:email,password:password,type:type,resubmitToken:resubmitToken, callback:callback, authType:authType, signature:signature, username:username},
