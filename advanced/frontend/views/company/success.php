            	...
            	<dl class="company_center_content">
	                ...
	                <dd> 
	                	...
	                	<div class="publish_tip">
                            <h2>恭喜你，职位发布成功！</h2>
                            <a target="_blank" href="?r=index/look&id=<?=$id?>">预览职位</a><br>
                                                        <a class="greylink" href="?r=company/create">继续发布新职位</a><br>
                                                        <a class="greylink" href="?r=company/myindex"> 进入我的公司主页</a><br>
