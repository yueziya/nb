    			...
    			<div class="content_mid">
    				<dl class="c_section c_section_mid">
    					...
    					<dd id="step2Form">
    						...
    						<a class="btn_cancel fr" href="?r=company/index04">跳过</a>
    ...
    <script>
		$(function(){
			$("#step2Submit").click(function(){
				var form_data = $("#labels").text();
				$.ajax({
					url:"index.php?r=company/tag",
					type:"post",
					// dataType:"json",
					data:{"labels":form_data},
					success:function(e){
						// alert(e);
                        if(e == 1){
            			window.location.href = 'index.php?r=company/index04';
                        }
					}
				})
			})
