            ...
            <div id="container">
                ...
                <div class="content_mid">
                    <dl class="c_section c_section_mid">
                        ...
                        <dd>
                            <form action="?r=company/index01" method="post" enctype="multipart/form-data">
                                ...
                                <h3>公司全称</h3>
                                <input type="text" placeholder="请输入公司名称，如:北京有限科技公司" value="" name="name" id="name" class="valid"> 
                                
                                <h3>公司简称</h3> <!--非必填-->
                                <input type="text" placeholder="请输入公司简称，如:拉勾" value="" name="jname" id="name" class="valid">    
                                
                                <h3>公司LOGO</h3> <!--非必填改必填-->
                                <input type="file"  value="" name="file" id="name" class="valid">
