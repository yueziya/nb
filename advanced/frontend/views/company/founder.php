        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form method="post" action="index.php?r=company/index04" id="memberForm" enctype="multipart/form-data">
	                    <div id="memberDiv">
		                    <div class="formWrapper">
		                        <div class="new_portrait">
			                        ...
			                        <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" name="user_file" id="myfiles0" class="myfiles">
		                            <em>
								                                尺寸：120*120px <br> 	
								                                大小：小于5M
		                            </em>
		                        ...
		                        <h3>创始人姓名</h3>
		                        <input type="text" placeholder="请输入创始人姓名" name="username" id="name0" class="s_input1 valid">
                    	...
                    	<a class="btn_cancel fr" href="?r=company/index02">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
