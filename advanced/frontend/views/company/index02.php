    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                <dt>
                    <h2><em></em>填写公司信息</h2>
				<a class="c_addjob"><i></i></a>
                </dt>
                <dd>
                	<div class="c_text">目标明确、前途光明的产品是吸引求职者的制胜法宝哦！</div>
                 	<img width="668" height="56" class="c_steps" alt="第四步" src="style/images/step4.png">
                    
                    <form method="post" action="index.php?r=company/index02" id="productForm" enctype="multipart/form-data">
                    	<div id="productDiv">
		                    <div class="formWrapper">
		                        <h3>产品海报</h3>
								<input type="file" title="支持jpg、jpeg、gif、png格式，文件小于5M" name="product_file" id="myfiles0">
		                        <h3>产品名称</h3>
                    	...
                    	<a class="btn_cancel fr" href="?r=company/index03">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
