	                ...
	                <div class="c_detail">
	                	<div style="background-color:#fff;" class="c_logo">
		                	<a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
		                				                			<img width="190" height="190" alt="公司logo" src="<?=$companyInfo['logo']?>">
	                    ...
	                    <div class="c_box companyName">
	                        	...
	                        	<a target="_blank" class="applyC" href="http://www.lagou.com/c/auth.html">申请认证</a>
	                        	                        <div class="clear"></div>
	                       		                   			...
	                       		                   			<h1 title="福建平潭协创进出口贸易有限公司" class="fullname"><?=$companyInfo['jname']?></h1>
	                        ...
	                        <div class="clear oneword" style="display: block;"><img width="17" height="15" src="style/images/quote_l.png">&nbsp; <span><?=$companyInfo['name']?></span> &nbsp;<img width="17" height="15" src="style/images/quote_r.png"></div>
       				...
       				<div id="Product">
	        					...
	        					<div class="product_wrap">
					                    ...
					                    <dd>
					                        <form method="post" class="productForm">
					                            ...
					                            <div class="cp_intro">
					                                ...
					                                <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500" value="1" class="s_textarea valid" name="productProfile"><?=$companyInfo['companyProfile']?></textarea>	
					                ...
					                <dl class="c_product">
					                    ...
					                    <dd>
					                    	<img width="380" height="220" alt="发大发" src="<?=$companyInfo['product_file']?>">
				                        	<div class="cp_intro">
				                        	<h3><a target="_blank" href="http://www.zmtpost.com"><?=$companyInfo['product']?></a></h3>
					                            <div class="scroll-pane" style="overflow: hidden; padding: 0px; width: 260px;">
					                            	
					                            <div class="jspContainer" style="width: 260px; height: 140px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 260px;"><div><?=$companyInfo['companyProfile']?></div></div></div></div>
					                        </div>
					                        <a title="编辑公司产品" class="c_edit product_edit" href="javascript:void(0)"></a>					            								            			<a title="新增公司产品" class="c_add product_add" href="javascript:void(0)"></a>
					            								                    </dd>
					                </dl>
       				...
       				<div id="Profile">
					            ...
					            <!--有介绍-->
					               <dl class="c_section" style="display: block;">
					                   	...
					                   	<dd>
					                   		<div class="c_intro"><?=$companyInfo['labels']?></div>
            ...
            <div class="content_r">
            	<div id="Tags">
	            	<div id="c_tags_show" class="c_tags solveWrap" style="display: block;">
	                    <table><tbody><tr><td>地点</td><td><?=$companyInfo['city']?></td></tr><tr><td>领域</td><td><?=$companyInfo['select_industry_hidden']?></td></tr><tr><td>规模</td><td><?=$companyInfo['select_scale_hidden']?></td></tr><tr><td>主页</td><td><a target="_blank" href="http://www.zmtpost.com"><?=$companyInfo['website']?></a></td></tr></tbody></table>
		                        ...
		                        <tr>
		                            ...
		                            <td>
		                                ...
		                                <div class="selectBox dn" id="box_sca" style="display: none;">
		                                    <ul class="reset">		                                    			                                    						                            			<li>少于15人</li>				                            				                                        		                                    						                            			<li>15-50人</li>				                            				                                        		                                    						                            			<li>50-150人</li>				                            				                                        		                                    						                            			<li class="current">150-500人</li>				                            				                                        		                                    						                            			<li>500-2000人</li>				                            				                                        		                                    						                            			<li>2000人以上</li>				                            				                                        		                                    </ul>
		                                </div>	
		                            </td>
		                        </tr>
		                        <tr>
                    	...
                    	<form class="dn" id="stageform">
	                    	...
	                    	<ul id="stagesList" class="reset">
				                    ...
				                    <div class="selectBoxShort dn" style="display: none;">
				                        <ul class="reset">                						                        						                        					                        							                        	<li>天使轮</li>					                        						                        					                        							                        	<li>A轮</li>					                        						                        					                        							                        	<li>B轮</li>					                        						                        					                        							                        	<li>C轮</li>					                        						                        					                        							                        	<li>D轮及以上</li>					                        						                        					                        							                        	<li>上市公司</li>
					                        						                        				                        </ul>
				                    </div>
				                    <label>投资机构</label>
