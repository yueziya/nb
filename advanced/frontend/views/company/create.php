    				...
    				<div class="content">
    					<dl class="company_center_content">
    						...
    						<dd>
    							...
    							<form action="?r=company/create" method="post">
    								...
    								<table class="btm">
    									...
    									<tr>
    										...
    										<td>工作城市</td>
    										<td>
    											<input type="text" placeholder="请输入工作城市，如：北京" value="" name="workAddress" id="workAddress">
    										</td>
    									</tr>
    								</tbody></table>
    								...
    								<table>
    									<tbody><tr>
    										<td width="25"><span class="redstar">*</span></td>
    										<td colspan="2">
    											接收简历邮箱： <span id="receiveEmailVal">1633616271@qq.com</span>
    											<input type="hidden" value="1633616271@qq.com" id="receiveEmail" name="email">
    										</td>
    									</tr>
    									<tr>
    										<td width="25"></td>
