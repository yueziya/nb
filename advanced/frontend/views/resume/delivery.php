    ...
    <div id="container">
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			                    			<li class="current">
                    				<a href="delivery.html?tag=-1">我投递的简历</a>
                    			</li>
                                ...
                                <?php foreach($list as $key =>$val) {?>                  
                             		<div class="d_item">
	                                   	...
	                                   	<a title="公司名称" class="d_jobname" target="_blank" href="http://www.lagou.com/c/25927.html">
	                                   		公司名称 <span><?=$val['site']?></span> 
	                                    </a>
	                                    <span class="d_time"><?=$val['releases']?></span>
	                                    <div class="clear"></div>
	                                    <div class="d_resume">
	                                    	使用简历：
	                                    	<span>
                                        ...
                                        <?php if($arr[$key]['status'] == 0) {?>
	                                    <a class="btn_showprogress" href="javascript:;">待查看<i></i></a>
                                        <?php }else if($arr[$key]['status'] == 1) {?>
                                        <a class="btn_showprogress" href="javascript:;">审核通过，请注意查看邮箱<i></i></a>
                                        <?php }else{?>
     ...
     <div class="progress_status	dn">
                               			...
                               			<ul class="status_list">
                               					...
                               					<div class="list_body">                               						                               							简历被lixiang标记为不合适<div>您的简历已收到，但目前您的工作经历与该职位不是很匹配，因此很抱歉地通知您无法进入面试。</div>                               						                               					</div>
                               				</li>
                               				<li class="bottom">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a href="?r=resume/collections">我收藏的职位</a>
            		<br>
