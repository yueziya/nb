...
try{
	...
	var jsload=new jsLoader();
         ...
         var jsurl=domain+"/auto_city/v_i_a_b/auto_area_news_v3_"+tmpname+".js";		jsload.load(jsurl);
		jsload.onsuccess=function(){
			...
			document.getElementById("car_city").innerHTML=htmlstring.replace(/<ul>|<\/ul>/g,"");
