                        ...
                        <div class="nest" id="elementClose">
                            ...
                            <div class="body-nest" id="element">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="?r=friend/add_friend" class="form-horizontal bucket-form" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">友链名称</label>
                                            <div class="col-sm-6">
                                                <input type="text"  name="friend_name" value="" id="disabledInput" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text"  name="friend_url" value="" id="disabledInput" class="form-control">
                                            </div>
                                        </div>
